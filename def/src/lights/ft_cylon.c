...
/*   Updated: 2023/05/12 13:03:50 by msoler-e         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static double	caps_intersection_return(double id[2],
	t_ray ray, t_cylinder cylon, t_vector3d c2)
{
	...
	//modificacio && per !! alert!!! crec aixi esta be
...
static double	caps_intersection(t_ray ray, t_cylinder cylon,
		t_vector3d c2)
{
	double		id[2];
	t_vector3d	ray_orig;
...
static double	ft_get_cylon(double *t0, double *t1,
		t_cylinder cylon, t_ray ray)
{
	t_vector3d	right;
	t_vector3d	cyl_normal;
	t_vector3d	cyl_center;
